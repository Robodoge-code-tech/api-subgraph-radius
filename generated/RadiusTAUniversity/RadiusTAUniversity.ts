...
export class RadiusTAUniversity extends ethereum.SmartContract {
  static bind(address: Address): RadiusTAUniversity {
    return new RadiusTAUniversity("RadiusTAUniversity", address);
  }
