...
export class RadiusMarketplace__auctionsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class RadiusMarketplace__nftSalesResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: i32;
...
export class RadiusMarketplace extends ethereum.SmartContract {
  static bind(address: Address): RadiusMarketplace {
  ...
  auctions(param0: BigInt): RadiusMarketplace__auctionsResult {
    let result = super.call(
      "auctions",
    ...
    return new RadiusMarketplace__auctionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auctions(
    param0: BigInt
  ): ethereum.CallResult<RadiusMarketplace__auctionsResult> {
    let result = super.tryCall(
      "auctions",
      "auctions(uint256):(uint256,address,uint256,uint256,uint256,address,uint256,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new RadiusMarketplace__auctionsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  nftSales(param0: BigInt): RadiusMarketplace__nftSalesResult {
    let result = super.call(
      "nftSales",
    ...
    return new RadiusMarketplace__nftSalesResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toI32()
  ...
  try_nftSales(
    param0: BigInt
  ): ethereum.CallResult<RadiusMarketplace__nftSalesResult> {
    let result = super.tryCall(
      "nftSales",
      "nftSales(uint256):(uint256,address,uint256,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RadiusMarketplace__nftSalesResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toI32()
