...
export class RadiusStakingNft__tierCollectionResult {
  value0: string;
  value1: string;
  value2: BigInt;
...
export class RadiusStakingNft__viewTierCollectionResultValue0Struct extends ethereum.Tuple {
  get image(): string {
...
export class RadiusStakingNft extends ethereum.SmartContract {
  static bind(address: Address): RadiusStakingNft {
    return new RadiusStakingNft("RadiusStakingNft", address);
  }
  ...
  tierCollection(
    param0: i32,
    param1: BigInt
  ): RadiusStakingNft__tierCollectionResult {
    let result = super.call(
      "tierCollection",
    ...
    return new RadiusStakingNft__tierCollectionResult(
      result[0].toString(),
      result[1].toString(),
      result[2].toBigInt()
    );
  ...
  try_tierCollection(
    param0: i32,
    param1: BigInt
  ): ethereum.CallResult<RadiusStakingNft__tierCollectionResult> {
    let result = super.tryCall(
      "tierCollection",
      "tierCollection(uint8,uint256):(string,string,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new RadiusStakingNft__tierCollectionResult(
        value[0].toString(),
        value[1].toString(),
        value[2].toBigInt()
      )
  ...
  viewTierCollection(
    _tier: i32
  ): Array<RadiusStakingNft__viewTierCollectionResultValue0Struct> {
    let result = super.call(
      "viewTierCollection",
    ...
    return result[0].toTupleArray<
      RadiusStakingNft__viewTierCollectionResultValue0Struct
    >();
  }
