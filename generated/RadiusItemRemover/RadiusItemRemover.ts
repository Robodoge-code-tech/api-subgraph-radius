...
export class RadiusItemRemover extends ethereum.SmartContract {
  static bind(address: Address): RadiusItemRemover {
    return new RadiusItemRemover("RadiusItemRemover", address);
  }
